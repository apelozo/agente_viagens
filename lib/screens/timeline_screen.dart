...
class _TimelineScreenState extends State<TimelineScreen> {
  ...
  Widget _blocoCard(Map<String, dynamic> block) {
    ...
    final hotelId = block['hotel_id'];
    final isLinkedToHotel = hotelId != null && hotelId.toString().trim().isNotEmpty;
          ...
          if (isLinkedToHotel) ...[
            ...
            Container(
              ...
              child: const Row(
                mainAxisSize: MainAxisSize.min,
                children: [
                  Icon(Icons.link_rounded, size: 14, color: Color(0xFF4338CA)),
                  SizedBox(width: 6),
                  Text(
                    'Vinculado a hotel (check-in)',
                    style: TextStyle(
